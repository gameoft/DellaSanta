...
namespace Dellasanta.Logging
{
    public static class Log4NetHelper
    {
        ...
        public static void Log(ILog logger, string message, LogLevel logLevel, string entityFormalNamePlural, int entityKeyValue, string userName, Exception exception)
        {
